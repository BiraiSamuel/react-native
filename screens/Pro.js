      ...
      <Block flex style={styles.container}>
        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              <Block>
                <Image source={Images.LisheLogo}
                  style={{ marginBottom: theme.SIZES.BASE * 1.5 }}/>
              </Block>
              <Block >
                <Block>
                  <Text color="white" size={60}>Lishe</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>Food</Text>
                </Block>
                <Block row>
                  <Text color="white" size={60}>Deliveries</Text>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Take advantage of all the local goods for your everyday nutrition and so much more.
              </Text>
